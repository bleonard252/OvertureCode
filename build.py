...
prefixed_fonts = [
  ...
  #'fonts/Overpass/fonts/ttf_mono/*.ttf',
  #'fonts/Overpass/fonts/otf_mono/*.otf',
]
...
renamed_fonts = {
  ...
  'fonts/overpass/fonts/otf_mono/*.otf': 'Overture Code',
  'fonts/overpass/fonts/ttf_mono/*.ttf': 'Overture Code',
}
